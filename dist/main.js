...
*/
        ...
        var _extends = Object.assign || function(target) {
            ...
            return _inherits(MinimalThemeNodeContentRenderer, _Component), _createClass(MinimalThemeNodeContentRenderer, [ {
                ...
                value: function() {
                    ...
                    _props.rowDirection, _objectWithoutProperties(_props, [ "scaffoldBlockPxWidth", "toggleChildrenVisibility", "connectDragPreview", "connectDragSource", "isDragging", "canDrop", "canDrag", "node", "title", "subtitle", "draggedNode", "path", "treeIndex", "isSearchMatch", "isSearchFocus", "icons", "buttons", "className", "style", "didDrop", "swapFrom", "swapLength", "swapDepth", "treeId", "isOver", "parentNode", "rowDirection" ])), nodeTitle = title || node.title, nodeSubtitle = subtitle || node.subtitle, dom = node.dom, hasDom = null != dom, isDraggedDescendant = draggedNode && isDescendant(draggedNode, node), isLandingPadActive = !didDrop && isDragging, nodeContent = connectDragPreview(_react2.default.createElement("div", {
                        className: _nodeContentRenderer2.default.rowContents + (isSearchMatch ? " " + _nodeContentRenderer2.default.rowSearchMatch : "") + (isSearchFocus ? " " + _nodeContentRenderer2.default.rowSearchFocus : "") + (canDrag ? "" : " " + _nodeContentRenderer2.default.rowContentsDragDisabled) + (hasDom ? " " + _nodeContentRenderer2.default.rowCustomDom : "")
                    }, hasDom && dom, !hasDom && _react2.default.createElement("div", {
                        ...
                        path: path,
                        treeIndex: treeIndex
                    }) : nodeSubtitle)), !hasDom && _react2.default.createElement("div", {
                    ...
                    })))), widthOffset = scaffoldBlockPxWidth / 45 * 52;
                    return _react2.default.createElement("div", _extends({
                        ...
                        onClick: function(e) {
                            return node.onClick && node.onClick(e, node);
                        }
    ...
    function(module, exports, __webpack_require__) {
        ...
        exports.locals = {
            ...
            rowCustomDom: "rstcustom__rowCustomDom",
